...
print "%2d simulations: mean plays = %3d, median plays = %3d, max plays = %5d, min plays = %3d" \
      % (simulations, total_pulls/simulations
         , fselect(all_pulls, (math.floor(simulations/2))), max(all_pulls), min(all_pulls))
